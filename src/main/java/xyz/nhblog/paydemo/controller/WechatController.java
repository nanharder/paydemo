...
public class WechatController {
    ...
    public String auth(@RequestParam("returnUrl") String returnUrl) {
        String url = "http://selldemonh.natapp1.cc/sell/wechat/userInfo";
        String redirectUrl = wxMpService.
                oauth2buildAuthorizationUrl(url, WxConsts.OAuth2Scope.SNSAPI_USERINFO, URLEncoder.encode(returnUrl));
